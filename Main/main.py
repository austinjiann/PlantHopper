        ...
        def on_snapshot(doc_snapshot, changes, read_time):
            ...
            for doc in doc_snapshot:
                ...
                if command == "water":
                    ...
                    WATER_SCAN_SECONDS = float(data.get("waterScanSeconds", 25))  # how long to scan before giving up
                    WATER_FIRE_SECONDS = float(data.get("waterFireSeconds", 7.0)) # how long to send found:true
